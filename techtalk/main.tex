...
\begin{document}
    ...
    \begin{frame}{Outline}
        ...
        \begin{itemize}
            ...
            \item What is the importance and role of an equation of state in a temporal simulation of a neutron star?
    ...
    \begin{frame}{Simulations of Neutron Stars: Nearing Publication}
        ``Dynamical evolution of fermion-boson stars with realistic equations of state'' under Prof. Ben Kain, College of the Holy Cross
        \begin{itemize}
            \item Simulate presence of dark matter as a boson; superimpose a complex scalar field
            \item First temporal simulations of these ``mixed'' stars using \textit{realistic} equations of state; hope is to see how dark matter could affect observable properties of neutron stars
